...
public class ShopController {
    ...
    private void initializeProductCards() {
        ...
        List<productCard> products = List.of(
                new productCard("Cordless Drill", "/project/demo/Images/CordlessDrill.png", "$18.20 - $18.75"),
                new productCard("Hand Drill", "/project/demo/Images/handdrill.png", "$15.00 - $16.50"),
                new productCard("Hand Saw", "/project/demo/Images/handsaw.png", "$12.00 - $10.00"),
                new productCard("Hand Vacuum", "/project/demo/Images/HandVacuum.png", "$15.50 - $16.30"),
                new productCard("Helmet", "/project/demo/Images/helmet.png", "$12.85 - $12.70"),
                new productCard("Metal Hand Jigsaw", "/project/demo/Images/metalhandjigsaw.png", "$20.00 - $21.50"),
                new productCard("Metal Shovel", "/project/demo/Images/metalshovel.png", "$10.75 - $11.00"),
                new productCard("Pipe Wrench", "/project/demo/Images/pipewrench.png", "$9.70 - $10.60"),
                new productCard("Rubber Hand Gloves", "/project/demo/Images/ruberhandgloves.png", "$5.00 - $6.50"),
                new productCard("Steel Hammer", "/project/demo/Images/steelhammer.png", "$7.50 - $8.20"),
                new productCard("Steel Plier", "/project/demo/Images/steelplier.png", "$9.70 - $10.60"),
                new productCard("Toolbox", "/project/demo/Images/toolbox.png", "$25.00 - $26.50")
        );
